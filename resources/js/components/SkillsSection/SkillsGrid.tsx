export default function SkillsGrid() {
    ...
    return (
        <div className="fontSergoe grid grid-cols-2 gap-8 lg:grid lg:grid-cols-3">
            {skills.map((skill, idx) => (
                <div
                    key={idx}
                    className="flex items-center gap-3 rounded-xl border border-gray-800 bg-[#181726] p-4"
                >
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#591c87]">
                        {skill.icon}
                    </div>
